...
namespace UnitTests.ApplicationCore.Entities.BasketTests
{
    public class BasketAddItem
    {
        ...
        {
            var basket = new Basket();
            basket.AddItem(_testCatalogItemId, _testUnitPrice, _testQuantity, addToExistingItem: true);
            basket.AddItem(_testCatalogItemId, _testUnitPrice, _testQuantity, addToExistingItem: true);
        ...
        public void KeepsOriginalUnitPriceIfMoreItemsAdded()
        {
            var basket = new Basket();
            basket.AddItem(_testCatalogItemId, _testUnitPrice, _testQuantity, addToExistingItem: true);
            basket.AddItem(_testCatalogItemId, _testUnitPrice * 2, _testQuantity, addToExistingItem: true);
