...
namespace Infrastructure.Services
{
    public class RequestProvider
    {
        ...
        public async Task<TResult> GetAsync<TResult>(string uri, string token = "", Dictionary<string, string> header = null)
        {
        ...
        public async Task<TResult> PostAsync<TResult>(string uri, TResult data, string token = "", Dictionary<string,string> header = null)
        {
