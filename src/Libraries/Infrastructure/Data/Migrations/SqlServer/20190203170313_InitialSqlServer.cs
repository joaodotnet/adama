        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemOrdered_ProductName = table.Column<string>(nullable: true),
                    ItemOrdered_PictureUri = table.Column<string>(nullable: true),
                    CustomizeItem_Description = table.Column<string>(nullable: true),
                    CustomizeItem_Name = table.Column<string>(nullable: true),
                    CustomizeItem_Colors = table.Column<string>(nullable: true),
                    CustomizeItem_CatalogTypeId = table.Column<int>(nullable: true),
                    CustomizeItem_ProductName = table.Column<string>(nullable: true),
                    CustomizeItem_PictureUri = table.Column<string>(nullable: true),
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
