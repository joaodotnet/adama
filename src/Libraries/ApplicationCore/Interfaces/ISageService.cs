...
namespace ApplicationCore.Interfaces
{
    public interface ISageService
    {
        ...
        Task<SageResponseDTO> CreateAnonymousInvoice(List<OrderItem> orderItems);
        Task<SageResponseDTO> CreateInvoiceWithTaxNumber(List<OrderItem> orderItems, string customerName, string taxNumber, string address, string postalCode, string city);
