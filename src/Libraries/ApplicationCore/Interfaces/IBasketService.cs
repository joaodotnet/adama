...
namespace ApplicationCore.Interfaces
{
    public interface IBasketService
    {
        ...
        Task AddItemToBasket(int basketId, int catalogItemId, decimal price, int quantity, int? option1 = null, int? option2 = null, int? option3 = null, string customizeName = null);
