using DamaApp.Core.Services.Basket;
using DamaApp.Core.Services.Catalog;
using DamaApp.Core.Services.Dependency;
...
namespace DamaApp.Core.ViewModels.Base
{
